# WIP | App Cohort Tracking Dashboard - Product Hotels banner
...
monthly_view_query = """ 
 WITH cohort_agg_device AS (   
  ...
  FROM user_scratch.x_amarium.cta_banner_campaign
...
FROM 
user_scratch.x_amarium.cta_banner_campaign
  --ANALYTICS.ACIES.CTA_LTV_ALL_CAMPAIGNS
WHERE 
...
FROM 
user_scratch.x_amarium.cta_banner_campaign main
  --ANALYTICS.ACIES.CTA_LTV_ALL_CAMPAIGNS 
            ...
            if st.button("Submit"):
                ...
                try:
                    ...
                    if included_campaigns:
                        update_true_query = f"""
                        UPDATE user_scratch.x_amarium.cta_banner_campaign
                            --ANALYTICS.ACIES.CTA_LTV_ALL_CAMPAIGNS
